			...
			if Voice == False or IsRed == True or Obstacle == True: # 멈춰 or 빨간불 or 장애물발견 시
				...
				num = int(num) # 선의 갯수
					...
					forward(0)
       		                 	...
       		                 	if CAR_CENTER - 20 <= x_point and x_point <= CAR_CENTER + 20: # 300~340 사이
	           	                        print "straight "
	                                        ...
	                                        forward(Speed)
                                                ...
                                                print "left ", (13 - x_point / 30)
                                                turn_left(13 - x_point / 30)
                                                forward(Speed)
	                                elif CAR_CENTER + 20 < x_point: # 우회전 # 340 초과 
                                                print "right ", (x_point / 30) - 7
                                                turn_right((x_point / 30) - 7)
                                                forward(Speed)
						...
						turn_left(22.5 - x_point / 20)
						print "left ", (22.5 - x_point/20)
	                       	       	 	forward(Speed)
	                       		elif CAR_CENTER + 150 < x_point and x_point <= 600: # 우회전 # 470 초과
	                               		turn_right((x_point / 21) - 14.5)
						print "right ", (x_point / 21) - 14.5
	                                	forward(Speed)
					elif x_point > 600:
						turn_right(14)
						forward(Speed)
	...
	while True:
		...
		isFire = False
			...
			if Voice == False or Obstacle == True:
				...
				if ((40 <= Bot_fire) and (Bot_fire <= 640)):
	                            	print("Fire!! : Car stop")
					Speed = 0
